(function ($) {
    ...
    $(".widget_sub_categories > a").on("click", function () {
        // Lấy danh mục con ngay bên dưới danh mục hiện tại
        var $nextDropdown = $(this).next(".widget_dropdown_categories");

        // Toggle class "active" cho danh mục hiện tại
        $(this).toggleClass("active");

        // Thực hiện slideToggle cho danh mục con ngay bên dưới danh mục hiện tại
        $nextDropdown.slideToggle("medium");
    });
