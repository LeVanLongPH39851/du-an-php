...
<form method="post" action="{{route('baiviet.store')}}" enctype="multipart/form-data" class="form-horizontal">
    @csrf
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Tiêu đề bài viết <span
        ...
        <div class="col-sm-10"><input type="text" name="name" placeholder="Nhập tiêu đề bài viết" class="form-control {{$errors->has('name') ? "is-invalid" : ""}}">
            @if ($errors->has('name'))
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Ảnh đại diện <span class="text-danger">(*)</span></label>
        ...
        <div class="col-sm-10"><input type="file" class="custom-file-input {{$errors->has('image') ? "is-invalid" : ""}}" name="image" onchange="showImage(event)">
            <img src="" style="margin-top: 5px; width:40px; display: none" id="image_san_pham" alt="image">
            @if ($errors->has('image'))
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Nội dung bài viết <span
        class="text-danger">(*)</span></label>
        <div class="col-sm-10"><textarea name="content" class="form-control" id="content" placeholder="Nhập nội dung bài viết"></textarea>
